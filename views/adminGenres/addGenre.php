  ...
  <div class="container">
      ...
      <div class="container">
          <div class="row">
              ...
              <div class="col-12">
                  <form action="/addGenreWithAjax" method="post" id="add-genre">
                      ...
                      <div class="my-4">
                        <input id="addGenreByAjax" type="button" class="form-control btn-info col-3" aria-label="Large" aria-describedby="inputGroup-sizing-sm" value="ADD Genre" />
                      </div>
                  </form>
              </div>
              <div id="spinner">
...
<script src="/./src/js/js_ajax_addGenre.js"></script>
