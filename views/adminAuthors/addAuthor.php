...
<div class="container">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12">
              <form action="/addAuthorWithAjax" method="post" id="add-author">
                  <div class="input-group input-group-lg">
                      <div class="input-group-prepend">
                          <span class="input-group-text" id="inputGroup-sizing-lg">Write here</span>
                      </div>
                      <input type="text" class="form-control" aria-label="Large" aria-describedby="inputGroup-sizing-sm" name="author" id="author">
                  </div>
                  <div class="my-4">
                    <input id="addAuthorByAjax" type="button" class="form-control btn-info col-3" aria-label="Large" aria-describedby="inputGroup-sizing-sm" value="ADD Author" />
                  </div>
              </form>
          </div>
...
<script src="/./src/js/js_ajax_addAuthor.js"></script>
